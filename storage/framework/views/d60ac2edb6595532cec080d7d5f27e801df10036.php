    ...
    <div class="card">
      <div class="card-body">
        <div class="d-sm-flex align-items-center mb-4">
          ...
          <a href="<?php echo e(route('testimonial.index')); ?>" class="text-dark ml-auto mb-3 mb-sm-0"> Lihat Semua Reservasi</a>
        </div>
...
<?php /**PATH D:\restaurant-site-laravel\resources\views/admin/pages/home/tabledisplay1.blade.php ENDPATH**/ ?>