...
<?php $component->withAttributes([]); ?>
	<div class="content-wrapper">
		<a href="<?php echo e(route('foodmenu.create')); ?>" class="btn btn-primary mx-2">Tambahkan Menu</a>
	</div>
	...
	<div class="content-wrapper">
		<div class="col-lg-12 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
					<h4 class="card-title">Data Menu Makanan</h4>
...
<?php endif; ?>
<?php /**PATH D:\restaurant-site-laravel\resources\views/admin/pages/foodmenu/foodmenu.blade.php ENDPATH**/ ?>